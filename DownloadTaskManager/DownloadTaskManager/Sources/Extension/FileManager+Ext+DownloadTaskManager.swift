...
//  MacOS Version: 11.4
//			
//  File Name: FileManager+Ext+DownloadTaskManager.swift
...
public extension FileManager
{
    ...
    static var s_LoggerSubsystem: String = Bundle.main.bundleIdentifier!
    static var s_LoggerCategory: String = "FileManager"
    static let s_Logger: Logger = .init(subsystem: s_LoggerSubsystem, category: FileManager.s_LoggerCategory)
}
